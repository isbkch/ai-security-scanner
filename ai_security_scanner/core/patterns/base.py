...
from ai_security_scanner.core.models import VulnerabilityResult, Location, Severity, Confidence
...
class VulnerabilityPattern(ABC):
    ...
    def __init__(self, name: str, description: str, severity: Severity, cwe_id: Optional[str] = None):
        self.name = name
    ...
    def _find_regex_matches(self, rule: PatternRule, code: str, file_path: str) -> List[VulnerabilityResult]:
